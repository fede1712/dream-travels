...
export const EditTripModal = ({
  ...
  const handleAddItineraryDay = () => {
    setActualTrip((prevTrip) => {
      const updatedItinerary: Itinerary[] = [
        ...prevTrip.itinerary,
        { day: prevTrip.itinerary.length + 1, location: "", description: "" },
      ];
      return { ...prevTrip, itinerary: updatedItinerary };
    });

    setItineraryDaysForm((prevElements) => [
      ...prevElements,
      <ItineraryForm
        itineraryDaysFormLength={itineraryDaysForm.length}
      ...
      <div className="bg-white mx-10 rounded-2xl p-6 shadow-lg sm:w-5/12 max-h-[90vh] overflow-y-auto my-10">
        ...
        <form onSubmit={handleSubmit} role="form">
          ...
          <label className="text-sm mb-2 flex justify-between items-center" htmlFor="name">
            ...
            <button role="add-button" type="button" onClick={handleAddItineraryDay}>
